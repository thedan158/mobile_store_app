...
export const ORDERS_DETAILS_REQUEST = "ALL_ORDERS_REQUEST";
export const ORDERS_DETAILS_SUCCESS = "ALL_ORDERS_SUCCESS";
export const ORDERS_DETAILS_FAIL = "ALL_ORDERS_FAIL";
